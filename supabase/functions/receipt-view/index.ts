...
const CSS = [
  ...
  ".inv-tbl th.c-qty{width:52px}",
  ".inv-tbl th.c-price,.inv-tbl th.c-disc,.inv-tbl th.c-tax{width:58px}",
  "@media(min-width:640px){.inv-tbl th,.inv-tbl td{padding:10px 8px}.inv-tbl th.c-qty{width:56px}.inv-tbl th.c-price,.inv-tbl th.c-disc,.inv-tbl th.c-tax{width:78px}}",
