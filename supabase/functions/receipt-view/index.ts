...
const CSS = [
  ...
  ".inv-tbl th,.inv-tbl td{padding:9px 4px;border-bottom:none;vertical-align:top;white-space:nowrap}",
  ...
  ".inv-tbl th.c-qty{width:34px}",
  ".inv-tbl th.c-price,.inv-tbl th.c-disc,.inv-tbl th.c-tax{width:58px}",
  "@media(min-width:640px){.inv-tbl th,.inv-tbl td{padding:10px 8px}.inv-tbl th.c-qty{width:44px}.inv-tbl th.c-price,.inv-tbl th.c-disc,.inv-tbl th.c-tax{width:78px}}",
